...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "If I land next Tuesday it's going to be hard to turn it down. I would be stupid to turn down near half a million and a lifetime of stability, even for Figma. I'm drawn to what New York could become and grow into, and now more recently afraid of what more bridges will burn with continued ascent. Yet I can't complain. Many would die for my position now, and I'm grateful. I still remember those days in SoMa, having to choose between groceries and an Uber."
    ]
  },
  {
    id: '005',
