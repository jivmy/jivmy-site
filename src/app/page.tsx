  ...
  return (
    <main className="min-h-screen bg-white relative my-2 sm:my-12 overflow-hidden">
      ...
      <Note number="003" date="01/23/25">
        <p className="!mt-0 first-letter">I've been inset in such a chaotic state. Every step I take crumbles into sawdust, revealing the next step, and yet I happen to be in a situation where standing and falling would bring me to a more ideal state. Running along the tide, my life would markedly improve. And yet I find it hard to make that decision, for reasons hard to articulate.</p>
