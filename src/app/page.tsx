  ...
  return (
    <main className="min-h-screen bg-white relative my-2 sm:my-12 overflow-hidden">
      ...
      <Note number="001" date="01/21/25">
        ...
        <p>If no shots land here, I'll go to Wuxi to visit family, then Cambodia, Vietnam, Laos. Barcelona for a couple years, moving through Europe. Stability won't find me, so I'll dance in the rain. I guess the world opens up when you've got nothing left to lose but your balance.</p>
