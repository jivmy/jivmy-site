...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Today, four days before being forced to leave the land I have called home for a decade, I signed a letter to lead a team of dozens across the most ambitious design project in human history: redesign design itself. I've said no to so many things that I've wanted for this moment… people, places, and faces… it's hard not to get emotional. Growing up, my mom would tell me, \"Save the core of a watermelon for those you love; it's the sweetest part.\" Long ago, I set out to become the best in the world at what I do. Today, I arrive at the gate of my American dream. I will always sacrifice what I want and shoulder a world of pain to give its equivalent and opposite to those I love. It's just how I was raised; it's my sweetest part."
    ]
  },
  {
    id: '003',
