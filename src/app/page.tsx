      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p>If I keep the thread on a pulse here, I will stay in love with life. In so many possibilities where I am not riding this career, with that person, or in such and such country, I smile, laugh, play, and thrive. Yet in all of those, I must keep falling, while getting back up.</p>
          </article>
        </div>
