...
const notes: NoteData[] = [
  {
    ...
    content: [
      "Across patterned sheets, bodies pass through through as usual, slurring with gin and false promises. Edges, some tattoos, and the names blur. I'm slipping into old habits, and respect is yet again not a prerequisite. What discipline I had in San Francisco could be seen as progress, but in another way it was a form of restraint. It's not like I don't believe in love... and it's not like I'm averse to sobriety. But this place has a way of pulling you. Maybe this works, although it's not ideal. More powders, pills, fun without any real discourse. Broken people that are enough for the moment, and that's the beauty of navigating the fringes.",
