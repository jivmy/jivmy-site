...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "I'd just gone through my first breakup a year before, and was in a way still reeling from it, cycling through faces and turning to a plethora of numbing drugs abbreviated to the entire alphabet. Back then I was a much different person, and in a way it's because I didn't believe in myself. Yet real self belief, I've learned in this brief period of unemployment that has become among the most challenging in my life, has nothing to do with pushing limits or yearning for things to work out. In fact, it's quite the opposite. Despite these months being the most challenging, it hasn't quite felt that way, and it's because I now hold an acute sense of certainty that things will not only be okay, but also a real opportunity, no matter what happens. Everything is a tradeoff, and often times giving up something good because of extenuating circumstances means finding something even better. What you find won't be better in all aspects, and comparisons may be made, but there is a way to see it as better, and not only that, it is actually in fact better in many ways. If you don't want to see that, you're not giving it a fair shot, and you're not giving yourself a fair shot to build something beautiful. I had for a long time associated leaving America with failure, and was afraid losing what I had built here. Now I see that there is nothing to have been afraid of. It's not worth it to trade what is real for a fantasy, and if Canada had become real, then it would have been have been my time to go home and do something else. Things aren't that black and white. What Canada lacks in some areas, it makes up for in others. I found it important to appreciate that.",
      "Speaking of fantasy, I think its real value is that it's unburdened by reality, which comes with compromises and difficulties. But that doesn't mean that the fantasy is better. In my experience, better is what you make of it, and I've learned to not make what is real and tangible the competitor of something that was never granted space to show its flaws. I moved to New York not because I didn't like California, but because I understood that what is uncomfortable often carries the most growth. I knew it was going to be a fight coming in, with the fall layoff. But at this stage in my life, I'm drawn to chaos. I like a bit of danger, things that are rough around the edges, and not too soft. Like many others, it's hard for me to love anything I fully understand, and that's one of my flaws, of which I have many. I'm not a perfect person, and though I'm too often cast into the following, I don't see myself as a teacher. Sometimes, I'm quite lazy. And other times, I don't treat people with the patience that they deserve. I can be mean, critical, dismissive, and at times a hypocrite. More yet, I can weaponize my way with words to paint an image that doesn't exist for self benefit. Just like New York, I am flawed and human. I admire that fantasy doesn't have breathing room to exist here. What the city carries is too raw for that. It's made me more practical, more grounded. Even now, I'm still learning."
    ]
  },
  {
    id: '004',
