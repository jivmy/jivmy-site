...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "I just want to say that I'm so happy to have spent such quality time here and to have met such unique and soulful people. I'm grateful, and humbled by my friends, and for the opportunity to push myself a little bit here. But I am so, so excited for Barcelona coming. I just don't love the aesthetic of the rat-race here."
    ]
  },
  {
    id: '003',
