...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Today, four days before being forced to leave the land I have called home for a decade, I signed a letter to lead a team of dozens across the most contentious design project in history: a chance to redefine the concept of what it means to be a designer. I've said no to so many things that I've wanted for this moment… people, places, and faces… it's hard not to get emotional.",
      "Growing up, my mom would tell me, \"Of all the buildings under my wing, I can see that you will become the tallest one.\" Once, I set out to become the best in the world at what I do. And today, I arrive at the gate of my American dream. I will always sacrifice what I want and shoulder a world of pain to give its equivalent and opposite to those I love. It's just how I was raised; it's my sweetest part."
    ]
  },
  {
    id: '003',
