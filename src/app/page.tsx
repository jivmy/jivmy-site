...
const notes: NoteData[] = [
  ...
  },
  {
    ...
    location: 'New York City',
    content: [
      "Last winter, I had a muse, and last summer, I found another. Maybe that's just how it goes—phases of intensity, followed by detachment. Nothing ever starts with the intention of being temporary, but you can feel it in the undertones. The way time moves too fast when you're with someone, how words come easier, how your mind sharpens in their presence. You start writing more, thinking more, feeling more. It's intoxicating. But the thing about muses is that they aren't meant to stay, but rather meant to show a lesson, to shine a better way forward.",
