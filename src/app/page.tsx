...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "So I signed up for two events each week to immerse myself in the city, as I had done in San Francisco. Over that time, I concluded that this place is not for me. New York City is about status and envy where California is about peace and connection. I'm much more for the latter, yet I don't enjoy making promises that I can't keep. I had to bite the bullet, learn and mature in a way more inflicted by this environment than self-prescription. Here, I've come to understand that I can't have everything I want, but also that I can have some of it. Having some things means saying a soft no to others, and having others means saying a hard no to the some. Despite it seeming so, living in adventure had never been my core value. I'm a builder, and I enjoy progress. I've had to make some difficult decision to distance relationships that I've held for decades. I've curtained storylines that I know could bloom into something tangible. And I've turned away from what brought me to this city, for the rational choice.",
