...
const notes: NoteData[] = [
  {
    ...
    content: [
      "I spent the 23rd year of my life chasing adventure, and near its end I followed through with my promise to move to New York. Now that everything has been solidified, I'm free to spill my beans. I'll start by saying that I think it's rare to cross paths with someone that you click with immediately, and even more rare for them to exert such an influence on you that drives you to think about a life beyond your own, even if just for a moment. I had been living in a stable and well designed chapter: each element of my life was curated for advancement. Confident and settled, I met someone that affirmed my core belief at the time: a man like me could have everything that he wants, and more. And so I was inspired to move to New York despite the known risks associated, because I believed that everything could, and would fall into place, because I'm a lucky person. I knew that we had six months of runway, and in that time I planned to pivot to my next thing and start my life in New York, the last remaining curiosity I carried about America.",
      "Yet in July, our company split into two. Half of us birthed a horror game in virtual reality for monkeys. I observed as it climbed into the top 100 games in the world, the top 10, and then the top 5. Becoming the most profitable and downloaded game on Meta Quest to ever exist, our design team got laid off in the fall and we began to sunset the main product. In a way, it was the first time I suffered an adult setback, and yet still I had faith that the cards would fall my way. Nearing four hundred rejections later and with time running thin on my visa, I met doubt for the first time. Was I here chasing a dream, or was I chasing an idea? I began to grapple with questions I hadn't for a half a decade. And so I did what I'd been taught to do when the stars misalign: fight. I pushed forward, and I moved to the Big Apple. I dedicated myself to a professional U.S.A. boxing gym, taking punches to feel the true gravity of what was being thrown my way. And I planned all the way through the end. Six contingency plans, nets, that fell into each other, with the last landing on dedicating the next years to Muay Thai training in Thailand. Still yet, the first remained to remain here, and find a path forward.",
      "So I signed up for two events each week to immerse myself in the city, as I had done in San Francisco. Over that time, I realized that this place is not for me. New York is about status and envy where California is about peace and connection. I am much more for the latter, and yet I don't enjoy making promises that I can't keep. I've had to bite the bullet, learn and mature in a way more inflicted by this environment than self-prescription. Here, I've come to understand that I can't have everything I want, but also that I can have some of it. Having some things means saying a soft no to others, and having others means saying a hard no to the some. Despite it seeming so, living a life of adventure had never been my core value. I'm a builder, and I enjoy progress. I've had to make some difficult decision to distance relationships that I've held close for decades. I've had to close storylines that I know could bloom into something tangible. And I've had to turn away from what brought me to this city, for what I know to be the rational choice.",
      "I've chosen my defined purpose: to encourage people to have fun dreaming. In both my career and personal life, I'm motivated to raise others up into the best versions of themselves. At times, that means closing paths. I see how this life in New York could blossom, and yet I choose to walk away. Not for something better, but because I've gained clarity on what I'm moving towards: an open atrium, soft linens, arcs of light cutting across glass onto raw oak slabs. Garden fruit with sweet wind carrying citrus, honey, and tulips. Bees gliding through a window, over a table with small mustard fingerprints, and out the garage while hurried by one of those fat fluffy dogs and a cat with short trimmed whiskers. Scents of rain, ube, mint, and sawdust. Slow vinyls and Riesling enjoyed under nights specked by a blanket of stars. White fish, chicken, and all the time in the world to read, share, laugh, and build towards a life worth staying for.",
      "What does that image look like? Do you see it? Hear it? In this next chapter, I've made the decision to trade what is gratifying and divergent, fun and sweet, for what is right and stable. It's a turning point in my maturity, to surrender what I want in the moment for what I know is best for the future. I don't ever leave things behind, I leave things away. I think that our positions in life are relative and a-directional. I don't know if this is the right path, but as a designer I carry conviction in my decisions by considering its associated and conclusive array of weighted subjective probabilities. I've made sure to arrive here myself, without any influence that I know would have swayed my thinking. Here in this moment, I sit in a period of calm. After visiting California earlier this week, I saw that it was never necessary to live a life marked by the next coolest thing. It's always been more important to be real and honest, and I've learned that hardship is not always the most productive path. In my life I've taken a variety of risks that have not paid off, but also many that have. In each one, I've believed that things are possible all the way through the end. I'm an emotional person, but I don't allow the weight of a feeling dictate my choices. We are all on our own paths, and we all make the decisions that are best for us. You should understand that I respect that, and even more, I admire that trait in people: knowing when to walk away, especially when it's the hard decision."
    ]
  },
  {
    date: '02/19/25',
