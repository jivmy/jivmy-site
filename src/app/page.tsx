      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p>So to answer your question, it's because I choose to be like still water. News hits, and I neither block the ripples nor let them crash through. Instead I let the stone fall, but slow its descent. It's necessary to let the chaos move through you at a slow speed. Like Charlie says, "Never let your guard drop. Always keep your hands up." Let the impact spread wide instead of deep. It doesn't hurt less, but you carry it better. You learn to become something new through it.</p>
