...
const notes: NoteData[] = [
  {
    ...
    content: [
      "Some part of me feels like life is short. Look at how fast time flies. It's nearing February, and I remember when this time felt so far away. Now, it's here. We're all kind of just drifting through it, clinging on to any possibility of permanence or stability for dear life. It's easy to say \"oh now is not the right time for this,\" or \"if I do this now, in the future I'll be able to have this.\" None of us knows that, and we ignore our hearts out of a degree of indecisiveness, or fear that if we were to ask for what we want, we'd face both our own and life's many limitations.",
      ...
      "In a way I feel like I'm addicted to the plot. I'm attached to living a life that has ups and down in different areas. We grew up on the final level of the map, and I've started fresh to try to get back there, just to make the story interesting. I know that moving to Spain is in itself a huge decision that I'll have to sacrifice even more for. I am scared... and I will do it. It opens up the possibility of my life, even though it closes any chance of many other things I also want.",
      ...
      "I have let some people down, and I have raised more up. I have said no to some things, and yes to more. I have seen both sides of luck, and I have told jokes that have made others laugh until they can't breathe and their bellies hurt. I have seen more than most, and have loved more than many. In through it all, I have become a better person: more steady, more confident, more certain that if the world were to crumble, I would remain stable."
    ]
  },
  {
    id: '003',
