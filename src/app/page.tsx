...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Sometimes, emotions don't need to be cut,   introspected as is natural to me: they just need to be felt, to be sat with until you move forward. When expectations run high, there's no room for organic and imperfect beauty. I'm aware that life's best things take time to grow, and so my avoidance of staying still stems from my inability to hold onto it in this phase of life. I'm not afraid of attachment to a place, person, or career, nor am I always chasing something new. It's only that my situation doesn't allow me to take a breath. If design is all about optimizing within constraints, motion is mine. If can't have what I want, so I've chosen the next best thing: variety.",
