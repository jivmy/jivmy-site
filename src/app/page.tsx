      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p>Still, time is running out. I come up on two months and a week before deportation. But I still have space to make something happen. It's not over yet.</p>
            ...
            <p>Life's funny like that. Sometimes you win, sometimes you're up against the wall. I spend these days reading, documenting, living. Quiet moments mixed with chaos. Underground wrestling brawls. Moving apartments. <a href="https://thewintershow.org" className="text-black hover:text-black/60 transition-colors duration-200">Winter Show</a> soon. Here lies a travel journal, while Instagram carries my aesthetic explorations. I'm here to express, not impress. Briefly, I want to admit the magnitude of what I can't have. I'm aware of it, and at peace with it. I just think it would be a shame to miss the sunrise for a sunset.</p>
            <p>So to answer your question earlier, I prefer to model my mind as still water. Bad news hits, and I neither block the ripples nor let them crash through. Instead I let the stone to fall, but slow its descent. It's necessary to let the chaos move through you at a slow speed. Like Charlie says, "Never let your guard drop. Always keep your hands up." Let the impact spread wide instead of deep. It doesn't hurt less, but you carry it better. You learn to become something new through it.</p>
            <p className="!mb-0">But to be clear, I'm still not sure about New York. Having so many friends around is so nice, and Woodside Boxing Academy gives this narrative a nice sheen. But something here drains you differently than in California, doesn't it? I know you feel the same. New York's got this gloomy spirit, like a wild horse. Looking now, I'm not sure that I want to tame it. Success doesn't sound as fun here as it does in California. Everything is changing fast. For later someday soon, I have a visual. Wide house, fresh linens, an arc of light cutting through glass onto an oak and birch palette with rounded and low furniture. Fresh cut fruit with sweet wind carrying hints of flowers. Bumblebees flying in through a cracked window, and out the garage, chased by one of those fluffy dogs and a cat with short whiskers. Scents of fresh rain, ube, mint, and sawdust. Slow burn vinyls and Riesling. But it's not time for that yet. I want to see more, be more, hurt more. I don't have to be a designer to be happy. It really, I've come to understand, can be anything.</p>
            <p>Should I remain able to keep the thread on a pulse or not here, I will stay in love with life. In so many worlds where I am not riding this career, with that person, or in such and such country, I smile, laugh, play, and thrive. Yet in all of those, I must keep falling, while getting back up. Not a knee on the floor.</p>
          </article>
        </div>
