...
const notes: NoteData[] = [
  {
    ...
    content: [
      "Look at how fast time flies. It's nearing February, and still I remember when this time felt so out of reach. Now, it's here. We're all kind of just drifting through it, clinging on to any possibility of permanence or stability for dear life. It's easy to say \"now is not the right time for this,\" or \"if I do this now, in the future I'll be able to have this.\" But who knows that? We ignore our hearts out of fear that if we were to ask for what we want, we'd face both our own and life's many limitations.",
