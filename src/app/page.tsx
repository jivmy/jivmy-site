...
const notes: NoteData[] = [
  ...
  },
  {
    ...
    date: '01/21/25',
    content: [
      "Most nights, I'm in their basement—gloves hitting bags, the shuffle of feet on the floor, Charlie calling out, \"Keep your hands up!\" You soon learn it's not about avoiding every punch. It's about choosing how to take them, learning how to absorb the imapct.",
