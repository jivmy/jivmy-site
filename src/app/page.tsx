          ...
          <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
            ...
            <div className="relative flex gap-16">
              ...
              >
                ...
                <p> Open house, fresh linens, an arc of light cutting through glass onto an oak and birch palette. Rounded and low furniture. Fresh cut fruit with sweet wind carrying hints of flowers. Bumblebees flying through a cracked window and out the garage, hurried out by one of those fluffy dogs and a black cat with short whiskers. Scents of rain, ube, mint, and sawdust. Slow burn vinyls and Riesling, white fish, chicken, no sight of steak, veal, sausage. Doritos.</p>
