...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Closing a decade long chapter, I feel a cocktail of anticipation, fear, longing, nostalgia, and determination. I feel very human, in an adult world where we're all just trying to figure it out, balance what we think is right with what we yearn for."
    ]
  },
  {
    id: '004',
