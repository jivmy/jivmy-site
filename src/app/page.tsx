...
const notes: NoteData[] = [
  {
    ...
    content: [
      "Some part of me feels like life is shorter than we feel it is. Look at how fast time flies. It's nearing February, and I remember when this time felt so far away. Now, it's here. We're kind of all just drifting through it, clinging on to any possibility of permanence or stability for dear life. It's easy to say \"oh now is not the right time for this,\" or \"if I do this now, in the future I'll be able to have this.\" Yet none of us know that, and we ignore what we really want out of a degree of indecisiveness, or fear that if we were to ask for it, we'd be confronted by both our own and life's many limitations on our desires.",
      "At the same time, there's a degree of truth rooted in our doubts about our dreams. I don't believe in ghosts, but it's never really the right timing, it's true, and we can never have everything we want. In these days, it seems like we dedicate our lives to a craft and see it wiped away by a machine in a matter of months. Part of me wants to step away from it all—the call of adventure—lift a house, and just chill out for the rest of my time here.",
      "In a way I feel like I'm addicted to the plot. I'm attached to living a life that has ups and down in different areas. I grew up on the final level of the map, and I've started fresh to try to get back there, just to make the story interesting. I know that moving to Spain is in itself a huge decision that I'll have to sacrifice even more for. I am scared, and I will do it. Because I recognize that it opens up the possibility of my life even more, even though it closes any chance of many other things I also want.",
      "I don't really know how to describe this emotion as I curtain a decade long chapter. I feel a cocktail of anticipation, fear, longing, nostalgia, and determination. I feel very human, in an adult world where we're all just trying to figure it out, balance what we think is right with what we yearn for."
    ]
  },
  {
    id: '004',
