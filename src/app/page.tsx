...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "From a $25 million dollar play project to the most defining role in the history of technology. It's not true product design. We are set to define the personality of the world's first digital species. It's calm now. Stillness exists under pressure. Few measure that in absence of table stakes, stillness carries no meaning, and without movement, there exists no table stakes. I went to New York to see if I would like it, and that I can't answer the question is enough signal to counter the tradeoffs. Now that I could stay, it seems that I wont. Although it's true that there was never a final destination, I have arrived."
    ]
  },
  {
    date: '02/25/25',
