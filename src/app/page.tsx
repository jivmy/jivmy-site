...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "And so, he writes. To see the answer before he has to stop long enough to face it. And so, his next entry will be about how to expand fulfillment without chasing becoming."
    ]
  },
  {
    id: '010',
