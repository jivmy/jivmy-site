...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Growing up, my mom would tell me, \"Of all the buildings under my wing, it seems that you may grow into the tallest one.\" Once, I set out to become the best in the world at what I do, giving my heart to create a future where technology is no longer plagued by mindless consumption. Here I arrive at the gate of my American dream. I will always sacrifice what I want and shoulder any magnitude to provide its equivalent and opposite to my family and our world. It's just how I was raised: my sweetest part."
    ]
  },
  {
    id: '003',
