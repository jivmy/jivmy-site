      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p> Wide house, fresh linens, an arc of light cutting through glass onto an oak and birch palette with rounded and low furniture. Fresh cut fruit with sweet wind carrying hints of flowers. Bumblebees flying in through a cracked window, and out the garage, chased by one of those fluffy dogs and a cat with short whiskers. Scents of fresh rain, ube, mint, and sawdust. Slow burn vinyls and Riesling.</p>
