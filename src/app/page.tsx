...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Growing up, my mom would tell me, \"Of all the buildings under my wing, I can see that you will become the tallest one.\" Once, I set out to become the best in the world at what I do, giving my heart to the world to create a future where technology is no longer plagued by mindless consumption. Here I arrive at the gate of my American dream. I will always sacrifice what I want and shoulder any weight to give its equivalent and opposite to those I love. It's how I was raised, and now my sweetest part."
    ]
  },
  {
    id: '003',
