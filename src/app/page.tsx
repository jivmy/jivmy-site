...
const notes: NoteData[] = [
  {
    ...
    content: [
      "When I was in Los Angeles, there was a period of time that I lived in a frat house, right before graduation. Not our own, but this house on Gayley available for rent to the general public. I walked in September and was greeted by this dude named Andrew. He was sinewy looking guy and slender, a particular white man in his mid fifties with caved cheeks. \"Andrew. Been here twelve years.\" It seems like I had walked into his house, and worse yet I discovered that the rooms had no bathroom. In fact, there was a group shower, which caused some anxiety. Washing my butt, I pictured Andrew coming in to clean himself, which caused more anxiety. So every time I took a shower, I'd remain vigilant. I couldn't sign a one year lease because I was moving to San Francisco after the quarter, so I settled in to the building reluctantly, bringing with me what little I had - an alarm clock, some books, a yoga mat, and a mini fridge. Down the hall, there lived a transfer student who asked to come to our parties, a Russian guy from... Russia, two 7 foot tall black dudes, and a chubby jazz saxophonist who would twiddle \"Autumn Leaves\" through the night (Andrew later punched him in the face for leaving his stuff in the hallway).",
      "I'd just gone through my first breakup a year before, and was in a way still reeling from it, cycling through new faces and mixing up cocktails of numbing drugs abbreviated to the entire alphabet. Back then I was a much different person, and in a way, it's because I didn't believe in myself. Yet real self belief, I've learned in this period of unemployment, has nothing to do with pushing limits or yearning for things to work out. In fact, it's quite the opposite. Despite these months being objectively bad, it hasn't quite felt that way, and it's because I now hold an acute sense of certainty that things will lead to something better no matter what happens. Everything in design is a tradeoff, and often times giving up something good because of extenuating circumstances means finding something even greater. And though what you find won't be better in all aspects, and though comparisons may be made, there is a way to see it as better. Not only that, it is actually in fact better, in many ways. If you can't see that, you're not giving it a fair shot, and you're not giving yourself a fair shot to build something beautiful. I had for a long time associated leaving America with failure, and was afraid of losing what I desired here. Now I see that there is nothing to have been afraid of. It's not worth it to trade what is real for a fantasy, and if Canada had become real, then it would have been have been my time to go home and do something else. Things aren't black and white. What Canada lacks in some areas, it makes up for in others. I now appreciate that.",
      "Speaking of fantasy, I think its real value is that it's unburdened by reality, which comes with compromises and difficulties. Yet reality has its own value. In my experience, better is what you make of it, and I've learned to not make what is real and tangible the competitor of something that has not had space to show its flaws. I moved to New York not because I didn't like California, or for some media romanticized image, but because I understood that what is uncomfortable carries the most growth. With the fall layoff and its implications, I knew it was going to be a fight coming in. But, I'm drawn to chaos. I like a bit of danger, things that are rough around the edges, and am averse to what is too soft. Like many others, it's hard for me to love anything I fully understand, and that's one of my flaws, of which I have many. I'm not a perfect person, and though I'm too often cast into the following, I don't see myself as a teacher. Sometimes, I'm quite lazy. And other times, I don't treat people with the patience that they deserve. I can be mean, critical, dismissive, and at times a hypocrite. More yet, I weaponize my way with words to paint images that don't exist. Just like New York, I am flawed and human. These days, I like that fantasy doesn't have breathing room to exist here. What the city carries is too raw for that. New York has made me more practical, more grounded, more refreshed. Even now, I'm still learning. Yet if I'm able to make the impossible happen next Tuesday, I hate to say it but I must make the choice to turn down this city, what it has to offer, and what was once my dream job.  No more unanswered questions remain here, and with that, I'm cool to sunset this vivaciousness for the responsible decision. In a way, California has become my home. I'm clear on what I want: an open house, fresh linens, arcs of light cutting through glass onto a raw oak and birch palette. Garden fruit with sweet wind carrying hints of citrus, honey, and flowers. Bees flying through a window, over a toddler with ketchup fingers, and out the garage, hurried out by one of those fluffy dogs and a cat with short whiskers. Scents of rain, ube, mint, and sawdust. Slow burn vinyls and Riesling. White fish, chicken, and all the time in the world to read, share, laugh, build towards, and live."
    ]
  },
  {
    id: '004',
