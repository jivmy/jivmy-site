      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p>It's not about what you do, or even who you become. It's about who you are becoming. Right now. In this moment. Unemployed in New York, training at a professional boxing gym in the winter cold, fresh off an autumn layoff and bombing the biggest interview of your life in the 9th round. Classic slip-up. But I'm here for the plot, carrying this quote in my pocket: "When you are as small and obscure as David was, you must find Goliath to attack." Maybe that's why Barcelona calls. Two years in Europe might blow the lid off this whole thing. Like that mouse in my apartment—the one I caught today—sometimes you need to know when to leave. I guess there was never actually a reason for me to be in America. It's all been in my head. This thing they call "The American Dream."</p>
