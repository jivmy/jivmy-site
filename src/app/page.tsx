...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "I have let some people down, and I have raised more up. I have said no to some things, and yes to more. I have seen both sides of luck, and I have told jokes that have made others laugh until they can't breathe and their bellies hurt. I have seen more than most, and have lost more than most. Through it all, I have become a better person: more steady, more confident, more certain that if the world were to crumble, I would remain stable."
    ]
  },
  {
    id: '003',
