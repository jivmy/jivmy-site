...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Figma pulled me in for different reasons. There's something about working on the tools themselves, something about shaping what others will use to create, to dream. How it all connects feels too natural to ignore.",
