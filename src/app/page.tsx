...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "Speaking of fantasy, I think its real value is that it's unburdened by reality, which comes with compromises and difficulties. Yet reality has its own value. In my experience, better is what you make of it, and I've learned to not spin what is real and tangible into the competitor of something that has not had space to reveal its flaws. I moved to New York not because I didn't like California, or for some media romanticized vision, but because I understood that what is uncomfortable carries the most growth. With the fall layoff and its implications, I knew it was going to be a fight coming in. But, I'm drawn to chaos. I like a bit of danger, things that are rough around the edges, and am averse to what is too soft. Like many others, it's hard for me to love anything I fully understand, and that's one of my flaws, of which I have many. I'm not a perfect person, and though I'm too often cast into the following role, I don't see myself as a teacher. Sometimes, I'm quite lazy. And other times, I don't treat people with the patience that they deserve. I can be mean, critical, dismissive, and at times a hypocrite. More yet, I weaponize my way with words to paint images that don't exist. Just like New York, I am human.",
