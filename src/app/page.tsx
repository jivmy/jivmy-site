...
const notes: NoteData[] = [
  {
    ...
    content: [
      "Some part of me feels like life is short. Look at how fast time flies. It's nearing February, and I remember when this time felt so far away. Now, it's here. We're all kind of just drifting through it, clinging on to any possibility of permanence or stability for dear life. It's easy to say \"oh now is not the right time for this,\" or \"if I do this now, in the future I'll be able to have that.\" None of us knows that, and we ignore our hearts out of a degree of indecisiveness, or fear that if we were to ask for what we want, we'd face both our own and life's many limitations.",
