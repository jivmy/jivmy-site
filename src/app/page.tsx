      ...
      <div className="relative mx-2 sm:mx-auto w-[calc(100%-1rem)] sm:w-full max-w-[85ch] px-4 sm:px-12 py-8 sm:py-12 border border-black/[0.03]">
        ...
        <div className="relative flex gap-16">
          ...
          >
            ...
            <p className="!mb-0">But to be fair, I'm still not sure about New York. Having so many friends around is so nice, and Woodside Boxing Academy gives this narrative a nice sheen. But something here drains you differently than in California, doesn't it? I know you feel the same. New York's got this gloomy spirit, like a wild horse. Looking now, I'm not sure that I want to tame it. Success does not sound as fun here as it does in California. Life is changing fast. Later someday soon I have a vision. Wide house, fresh linens, lots of sun. Oak and birch palette with rounded and low furniture. Fresh cut fruit, a bee flying in through an open window, and out the back, chased by one of those fluffy dogs and a cat with short whiskers. Smell of fresh rain, flowers. Slow vinyls and Riesling. But it's not time for that yet. I want to see more, be more. I don't have to be a designer to be happy. I can be anything.</p>
            <p>Should I remain able to keep the thread on a pulse here, I will stay in love with life. In so many worlds where I am not riding this career, with that person, or in such and such country, I smile, laugh, play, and thrive. Yet in all of those, I must keep falling, while getting back up. Guard high. Never a knee on the floor.</p>
          </article>
        </div>
