...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "I'm here to prepare for the most critical interview of my career: Microsoft AI. Success is a lonely road, and counter to my extroverted nature. I'm afraid of what is fleeting, and so I let go of it before it has a chance to hurt me. I recognize that on the surface to many, I may appear detached, romanticize struggle, am reluctant to stay still, reaching for something with a sort of lone-wolf complex. But it's not true. I have good people around me, and enough of them that I've chosen put a stake in the ground and say that the rest, not that they don't matter, but that I can't let them matter. I push people away because I know that I'm not good for them, not in who I am, but in my stability in this country. At any moment, it can all be taken away from me. I'm not yet strong enough to raise a shield that can protect those I love, and despite being at a career high, I'm not as strong as I was when I was in a stable state, in San Francisco. New York has been tough, and in the back of my mind I'm averse to all its noise. Yet I'm an optimist, and see its potential yet still. Staying in America is my statement that no matter what happens, I'll act with courage.",
      "Quite a while ago, I heard this saying that some people are optimizers, and others are satisfiers. With relationships and career, some people take what then can get with contentment, and others strive for the best that they can do, never satisfied. At heart, I'm a satisfier. Near everybody that enters my life holds a high opinion of me, not for my achievements, but for my warmth towards them. I understand that people are not perfect, and so I'm able to love a wide variety of people, despite their flaws. Yet in my career, I'm an optimizer. In the past months, I have applied to thousands of roles, facing dozens of inbox rejections each morning, before stumbling into the holy grail of all design projects. Luck plays a factor, and in this situation it seems to be the major one. As a man, you are told that your value comes from material success, and as a designer, what you work on in part defines your identity in a way that doesn't for more traditional industries. I've felt lost, drifting, in a sea of faces and around the arms of strangers I have nothing in common with, deep in substances that have no business being in my body. And yet I keep moving. I choose to stay, even if I know I could be giving more of myself to the mission. I'm imperfect, and I allow myself grace to be so, in a time where everything is uncertain. In time I will return stronger, and I'll find my footing.",
      "Once ago I told Erin that my greatest fear was growing old, and when we broke up, I told her that I finally understood it. I'm not afraid of aging, I'm afraid of stagnation. But now I see that stagnation isn't real. Like an escalator, you're either moving forward or backward. Even more, I've become aware that the best attitude is ambivalence towards either direction, yet I'm short on the maturity to feel that way when the world spins under my feet.",
      "Sometimes, emotions don't need to be diced,   introspected as is natural to me: they just need to be felt, to be sat with until you move forward. When expectations run high, there's no room for organic and imperfect beauty. I'm aware that life's best things take time to grow, and so my avoidance of staying still stems from my inability to hold onto it in this phase of life. I'm not afraid of attachment to a place, person, or career, nor am I always chasing something new. It's only that my situation doesn't allow me to take a breath. If design is all about optimizing within constraints, motion is mine. If can't have what I want, so I've chosen the next best thing: variety.",
      "Star patterns line the rim of my matcha cup; I pick it up, and take a sip. Spencer sits across from me, reading Dostoevsky. In some ways, the contrast that surrounds my life has allure. I'm aware of my own negative behavior, pushing others away. Through my way with words, I'm able to rationalize it, recognize that it's not healthy, but also that it's not forever. Only, it's a cost I have to pay to maximize my chance of success. Although it's difficult, I see a future where I have it: an open house, fresh linens, arcs of light cutting through glass onto a raw oak and birch palette. Garden fruit with sweet wind carrying hints of citrus, honey, and flowers. Bees gliding through a jarred window, over a table with small ketchup fingerprints, and out the garage, hurried out by one of those fluffy dogs and a puffy cat with short whiskers. Scents of rain, ube, mint, and sawdust. Burned vinyls and Riesling enjoyed under nights specked with thousands of stars. Tender fish, chicken. All the time in the world to laugh, share, and build towards a better future."
    ]
  },
  {
    id: '008',
    ...
    content: [
      ...
      "Each time, attachment forms too quickly. I saw it happening in real time, like watching myself make a mistake I couldn't stop. That's when I realized I was slipping into old habits, mistaking inspiration for permanence. That's not what I want right now—not in this season of my life, not while everything is still in motion. So now I prefer things casual. Moving in and out of people's lives, and letting them do the same with mine. No expectations, and no illusions of forever. Just presence, growth, and understanding.",
