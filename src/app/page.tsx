...
const notes: NoteData[] = [
  {
    ...
    content: [
      ...
      "I see this. It's definitely an emotional response, yet it's one that protects me from harm and allows me to move forward. Yeah I didn't have to delete thousands of followers, but now I don't have to watch thousands of stories and get a thousand doses of FOMO. I still I have twenty people in my life at all times that have my back to the highest degree. It's all I need: quality over quantity, and it's more of both than most.",
